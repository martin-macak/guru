...
**Examples:**
- PR/Issue: `chore: Add naming conventions to AGENTS.md`
...
- Codex hooks (`.Codex/settings.json`) auto-run `ruff check --fix` + `ruff format`
...
- `Codex-review.yml` — Codex review behind `require-Codex-review` label
- `Codex.yml` — @Codex mentions in PR comments
